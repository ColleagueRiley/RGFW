...
ifeq ($(WAYLAND),1)
	...
	NO_EGL = 0
	NO_OSMESA ?= 0
	LIBS += -D RGFW_WAYLAND relative-pointer-unstable-v1-client-protocol.c xdg-output-unstable-v1.c xdg-decoration-unstable-v1.c xdg-toplevel-icon-v1.c xdg-shell.c -lwayland-cursor -lwayland-client -lxkbcommon  -lwayland-egl -lEGL
	LINK_GL1 = -lEGL -lGL
