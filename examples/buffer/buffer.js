...
var ASM_CONSTS = {
  66008: () => { Module.useWebGL = true; GLImmediate.init(); },  
 66054: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 66125: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 66182: () => { return window.mouseX || 0; },  
 66213: () => { return window.mouseY || 0; },  
 66244: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 66391: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 66444: () => { return window.innerWidth; },  
 66474: () => { return window.innerHeight; }
};
