...
var ASM_CONSTS = {
 ...
 73003: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73074: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73131: () => { return window.mouseX || 0; },  
 73162: () => { return window.mouseY || 0; },  
 73193: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73340: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73393: () => { return window.innerWidth; },  
 73423: () => { return window.innerHeight; },  
 73454: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 73734: () => { Module.requestFullscreen(false, true); },  
 73773: () => { Module.exitFullscreen(false, true); },  
 73809: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
