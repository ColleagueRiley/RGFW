...
var ASM_CONSTS = {
 ...
 71700: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71771: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71828: () => { return window.mouseX || 0; },  
 71859: () => { return window.mouseY || 0; },  
 71890: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 72037: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72090: () => { return window.innerWidth; },  
 72120: () => { return window.innerHeight; },  
 72151: () => { Module.requestFullscreen(false, true); }
};
