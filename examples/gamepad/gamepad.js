...
var ASM_CONSTS = {
 ...
 73471: () => { return 'Asyncify' in Module; },  
 73504: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73575: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73632: () => { return window.mouseX || 0; },  
 73663: () => { return window.mouseY || 0; },  
 73694: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73841: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73894: () => { Module.useWebGL = true; GLImmediate.init(); },  
 73940: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 74220: () => { return window.innerWidth; },  
 74250: () => { return window.innerHeight; },  
 74281: () => { Module.requestFullscreen(false, true); },  
 74320: () => { Module.exitFullscreen(false, true); },  
 74356: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
