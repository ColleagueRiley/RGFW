...
var ASM_CONSTS = {
 ...
 71696: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71767: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71824: () => { return window.mouseX || 0; },  
 71855: () => { return window.mouseY || 0; },  
 71886: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 72033: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72086: () => { return window.innerWidth; },  
 72116: () => { return window.innerHeight; },  
 72147: () => { Module.requestFullscreen(false, true); }
};
