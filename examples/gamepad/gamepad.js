...
var ASM_CONSTS = {
 ...
 75983: () => { Module.requestFullscreen(false, true); },  
 76022: () => { Module.exitFullscreen(false, true); },  
 76058: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
