...
var ASM_CONSTS = {
 ...
 70919: () => { return 'Asyncify' in Module; },  
 70952: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71023: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71080: () => { return window.mouseX || 0; },  
 71111: () => { return window.mouseY || 0; },  
 71142: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71289: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71342: () => { Module.useWebGL = true; GLImmediate.init(); },  
 71388: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 71668: () => { return window.innerWidth; },  
 71698: () => { return window.innerHeight; },  
 71729: () => { Module.requestFullscreen(false, true); },  
 71768: () => { Module.exitFullscreen(false, true); },  
 71804: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
