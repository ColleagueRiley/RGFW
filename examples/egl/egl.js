...
var ASM_CONSTS = {
 ...
 73913: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73984: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 74041: () => { return window.mouseX || 0; },  
 74072: () => { return window.mouseY || 0; },  
 74103: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 74250: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 74303: () => { Module.useWebGL = true; GLImmediate.init(); },  
 74349: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 74629: () => { return window.innerWidth; },  
 74659: () => { return window.innerHeight; },  
 74690: () => { Module.requestFullscreen(false, true); },  
 74729: () => { Module.exitFullscreen(false, true); },  
 74765: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
