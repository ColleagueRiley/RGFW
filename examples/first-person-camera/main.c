...
int main(void) {
    RGFW_window* win = RGFW_createWindow("First person camrea", RGFW_RECT(0, 0, 800, 450), RGFW_CENTER | RGFW_NO_RESIZE);
    win->fpsCap = 60;
