...
var ASM_CONSTS = {
 ...
 74955: () => { Module.requestFullscreen(false, true); },  
 74994: () => { Module.exitFullscreen(false, true); },  
 75030: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
