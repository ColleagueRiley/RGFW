...
var ASM_CONSTS = {
 ...
 73414: () => { return window.innerWidth; },  
 73444: () => { return window.innerHeight; },  
 73475: () => { Module.requestFullscreen(false, true); },  
 73514: () => { Module.exitFullscreen(false, true); },  
 73550: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
