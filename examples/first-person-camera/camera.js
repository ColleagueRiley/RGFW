...
var ASM_CONSTS = {
 ...
 71652: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71723: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71780: () => { return window.mouseX || 0; },  
 71811: () => { return window.mouseY || 0; },  
 71842: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71989: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72042: () => { Module.useWebGL = true; GLImmediate.init(); },  
