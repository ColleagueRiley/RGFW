...
var ASM_CONSTS = {
  68984: () => { Module.canvas.focus(); },  
 69009: () => { Module.useWebGL = true; GLImmediate.init(); },  
 ...
 70074: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70145: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70202: () => { return window.mouseX || 0; },  
 70233: () => { return window.mouseY || 0; },  
 70264: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70411: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70464: () => { return window.innerWidth; },  
 70494: () => { return window.innerHeight; }
};
