...
var ASM_CONSTS = {
 ...
 72349: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 72420: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 72477: () => { return window.mouseX || 0; },  
 72508: () => { return window.mouseY || 0; },  
 72539: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 72686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72739: () => { return window.innerWidth; },  
 72769: () => { return window.innerHeight; }
};
