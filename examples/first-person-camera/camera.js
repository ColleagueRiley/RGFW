...
var ASM_CONSTS = {
 ...
 71369: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71440: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71497: () => { return window.mouseX || 0; },  
 71528: () => { return window.mouseY || 0; },  
 71559: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71706: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71759: () => { return window.innerWidth; },  
 71789: () => { return window.innerHeight; },  
 71820: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 72100: () => { Module.requestFullscreen(false, true); },  
 72139: () => { Module.exitFullscreen(false, true); },  
 72175: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
