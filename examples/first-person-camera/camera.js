...
var ASM_CONSTS = {
 ...
 70742: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70813: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70870: () => { return window.mouseX || 0; },  
 70901: () => { return window.mouseY || 0; },  
 70932: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71079: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71132: () => { return window.innerWidth; },  
 71162: () => { return window.innerHeight; }
};
