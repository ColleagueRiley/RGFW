...
var ASM_CONSTS = {
 ...
 72289: () => { return window.innerWidth; },  
 72319: () => { return window.innerHeight; },  
 72350: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 72407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
