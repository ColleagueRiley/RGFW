...
var ASM_CONSTS = {
 ...
 70503: () => { Module.requestFullscreen(false, true); },  
 70542: () => { Module.exitFullscreen(false, true); },  
 70578: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
