...
var ASM_CONSTS = {
 ...
 69801: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69872: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69929: () => { return window.mouseX || 0; },  
 69960: () => { return window.mouseY || 0; },  
 69991: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70138: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70191: () => { return window.innerWidth; },  
 70221: () => { return window.innerHeight; },  
 70252: () => { Module.requestFullscreen(false, true); },  
 70291: () => { Module.exitFullscreen(false, true); },  
 70327: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
