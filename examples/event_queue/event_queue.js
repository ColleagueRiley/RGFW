...
var ASM_CONSTS = {
 ...
 69856: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69927: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69984: () => { return window.mouseX || 0; },  
 70015: () => { return window.mouseY || 0; },  
 70046: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70193: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70246: () => { return window.innerWidth; },  
 70276: () => { return window.innerHeight; },  
 70307: () => { Module.requestFullscreen(false, true); },  
 70346: () => { Module.exitFullscreen(false, true); },  
 70382: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
