...
var ASM_CONSTS = {
  67192: () => { Module.canvas.focus(); },  
 67217: ($0, $1, $2, $3, $4) => { var data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = document.getElementById("canvas").getContext("2d"); let image = context.getImageData(0, 0, $1, $2); image.data.set(data); context.putImageData(image, 0, $4 - $2); },  
 ...
 70149: () => { return window.innerWidth; },  
 70179: () => { return window.innerHeight; },  
 70210: () => { Module.requestFullscreen(false, true); },  
 70249: () => { Module.exitFullscreen(false, true); },  
 70285: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
