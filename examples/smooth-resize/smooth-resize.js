...
var ASM_CONSTS = {
  66800: () => { Module.canvas.focus(); },  
 66825: () => { Module.useWebGL = true; GLImmediate.init(); },  
 ...
 69226: () => { return window.innerWidth; },  
 69256: () => { return window.innerHeight; },  
 69287: () => { Module.requestFullscreen(false, true); },  
 69326: () => { Module.exitFullscreen(false, true); },  
 69362: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
