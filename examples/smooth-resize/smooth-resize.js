...
var ASM_CONSTS = {
 ...
 69181: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69252: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69309: () => { return window.mouseX || 0; },  
 69340: () => { return window.mouseY || 0; },  
 69371: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69571: () => { return window.innerWidth; },  
 69601: () => { return window.innerHeight; },  
 69632: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 69912: () => { Module.requestFullscreen(false, true); },  
 69951: () => { Module.exitFullscreen(false, true); },  
 69987: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
