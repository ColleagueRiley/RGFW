...
var ASM_CONSTS = {
 ...
 70375: () => { return 'Asyncify' in Module; },  
 70408: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70479: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70536: () => { return window.mouseX || 0; },  
 70567: () => { return window.mouseY || 0; },  
 70598: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70745: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70798: () => { Module.useWebGL = true; GLImmediate.init(); },  
 70844: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 71124: () => { return window.innerWidth; },  
 71154: () => { return window.innerHeight; },  
 71185: () => { Module.requestFullscreen(false, true); },  
 71224: () => { Module.exitFullscreen(false, true); },  
 71260: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
