...
var ASM_CONSTS = {
 ...
 70184: () => { return window.innerWidth; },  
 70214: () => { return window.innerHeight; },  
 70245: () => { Module.requestFullscreen(false, true); },  
 70284: () => { Module.exitFullscreen(false, true); },  
 70320: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
