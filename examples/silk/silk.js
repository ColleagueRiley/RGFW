...
var ASM_CONSTS = {
 ...
 74673: () => { return window.innerWidth; },  
 74703: () => { return window.innerHeight; },  
 74734: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 74791: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
