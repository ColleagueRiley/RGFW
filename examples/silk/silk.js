...
var ASM_CONSTS = {
 ...
 73396: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73467: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73524: () => { return window.mouseX || 0; },  
 73555: () => { return window.mouseY || 0; },  
 73586: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73733: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73786: () => { return window.innerWidth; },  
 73816: () => { return window.innerHeight; },  
 73847: () => { Module.requestFullscreen(false, true); },  
 73886: () => { Module.exitFullscreen(false, true); },  
 73922: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
