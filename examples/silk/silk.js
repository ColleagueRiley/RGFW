...
var ASM_CONSTS = {
  73480: () => { Module.useWebGL = true; GLImmediate.init(); },  
 73526: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73597: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73654: () => { return window.mouseX || 0; },  
 73685: () => { return window.mouseY || 0; },  
 73716: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73863: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73916: () => { return window.innerWidth; },  
 73946: () => { return window.innerHeight; }
};
