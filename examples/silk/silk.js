...
var ASM_CONSTS = {
 ...
 73232: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 73303: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73360: () => { return window.mouseX || 0; },  
 73391: () => { return window.mouseY || 0; },  
 73422: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73569: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73622: () => { return window.innerWidth; },  
 73652: () => { return window.innerHeight; },  
 73683: () => { Module.requestFullscreen(false, true); }
};
