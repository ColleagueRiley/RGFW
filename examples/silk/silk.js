...
var ASM_CONSTS = {
 ...
 74625: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 74696: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 74753: () => { return window.mouseX || 0; },  
 74784: () => { return window.mouseY || 0; },  
 74815: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 74962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 75015: () => { return window.innerWidth; },  
 75045: () => { return window.innerHeight; }
};
