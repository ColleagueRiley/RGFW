...
var ASM_CONSTS = {
 ...
 418409: ($0, $1, $2, $3, $4) => { var data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = document.getElementById("canvas").getContext("2d"); let image = context.getImageData(0, 0, $1, $2); image.data.set(data); context.putImageData(image, 0, $4 - $2); },  
 ...
 420616: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 420687: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 420744: () => { return window.mouseX || 0; },  
 420775: () => { return window.mouseY || 0; },  
 420806: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 420953: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 421006: () => { return window.innerWidth; },  
 421036: () => { return window.innerHeight; },  
 421067: () => { Module.requestFullscreen(false, true); },  
 421106: () => { Module.exitFullscreen(false, true); },  
 421142: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
