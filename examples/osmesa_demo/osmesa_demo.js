...
var ASM_CONSTS = {
 ...
 420623: () => { return 'Asyncify' in Module; },  
 420656: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 420727: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 420784: () => { return window.mouseX || 0; },  
 420815: () => { return window.mouseY || 0; },  
 420846: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 420993: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 421046: () => { return window.innerWidth; },  
 421076: () => { return window.innerHeight; },  
 421107: () => { Module.requestFullscreen(false, true); },  
 421146: () => { Module.exitFullscreen(false, true); },  
 421182: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
