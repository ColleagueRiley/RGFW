...
var ASM_CONSTS = {
 ...
 424052: () => { Module.requestFullscreen(false, true); },  
 424091: () => { Module.exitFullscreen(false, true); },  
 424127: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
