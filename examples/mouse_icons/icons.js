...
var ASM_CONSTS = {
 ...
 79806: () => { Module.requestFullscreen(false, true); },  
 79845: () => { Module.exitFullscreen(false, true); },  
 79881: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
