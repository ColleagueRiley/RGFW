...
var ASM_CONSTS = {
 ...
 69276: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69347: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69404: () => { return window.mouseX || 0; },  
 69435: () => { return window.mouseY || 0; },  
 69466: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69613: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69666: () => { return window.innerWidth; },  
 69696: () => { return window.innerHeight; },  
 69727: () => { Module.requestFullscreen(false, true); },  
 69766: () => { Module.exitFullscreen(false, true); },  
 69802: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
