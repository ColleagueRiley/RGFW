...
var ASM_CONSTS = {
 ...
 69425: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69496: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69553: () => { return window.mouseX || 0; },  
 69584: () => { return window.mouseY || 0; },  
 69615: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69762: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69815: () => { return window.innerWidth; },  
 69845: () => { return window.innerHeight; },  
