...
var ASM_CONSTS = {
 ...
 73191: () => { Module.requestFullscreen(false, true); },  
 73230: () => { Module.exitFullscreen(false, true); },  
 73266: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
