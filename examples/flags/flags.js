...
var ASM_CONSTS = {
 ...
 69605: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69676: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69733: () => { return window.mouseX || 0; },  
 69764: () => { return window.mouseY || 0; },  
 69795: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69995: () => { return window.innerWidth; },  
 70025: () => { return window.innerHeight; },  
 70056: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70336: () => { Module.requestFullscreen(false, true); },  
 70375: () => { Module.exitFullscreen(false, true); },  
 70411: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
