...
var ASM_CONSTS = {
 ...
 70419: () => { Module.requestFullscreen(false, true); },  
 70458: () => { Module.exitFullscreen(false, true); },  
 70494: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
