...
var ASM_CONSTS = {
  67920: () => { Module.canvas.focus(); },  
 67945: ($0, $1, $2, $3, $4) => { var data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = document.getElementById("canvas").getContext("2d"); let image = context.getImageData(0, 0, $1, $2); image.data.set(data); context.putImageData(image, 0, $4 - $2); },  
 68180: () => { return window.devicePixelRatio || 1; },  
 68219: () => { return window.innerWidth || 0; },  
 68252: () => { return window.innerHeight || 0; },  
