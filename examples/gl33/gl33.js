...
var ASM_CONSTS = {
 ...
 68975: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69046: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69103: () => { return window.mouseX || 0; },  
 69134: () => { return window.mouseY || 0; },  
 69165: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69312: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69365: () => { return window.innerWidth; },  
 69395: () => { return window.innerHeight; }
};
