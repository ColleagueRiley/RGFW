...
var ASM_CONSTS = {
 ...
 69892: () => { return window.innerWidth; },  
 69922: () => { return window.innerHeight; },  
 69953: () => { Module.requestFullscreen(false, true); },  
 69992: () => { Module.exitFullscreen(false, true); },  
 70028: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
