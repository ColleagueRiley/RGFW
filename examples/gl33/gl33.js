...
var ASM_CONSTS = {
 ...
 70435: () => { return window.innerWidth; },  
 70465: () => { return window.innerHeight; },  
 70496: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70553: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
