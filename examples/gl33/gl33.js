...
var ASM_CONSTS = {
 ...
 73353: () => { Module.requestFullscreen(false, true); },  
 73392: () => { Module.exitFullscreen(false, true); },  
 73428: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
