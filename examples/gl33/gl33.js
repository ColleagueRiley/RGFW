...
var ASM_CONSTS = {
 ...
 69751: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69822: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69879: () => { return window.mouseX || 0; },  
 69910: () => { return window.mouseY || 0; },  
 69941: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70088: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70141: () => { return window.innerWidth; },  
 70171: () => { return window.innerHeight; },  
 70202: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70482: () => { Module.requestFullscreen(false, true); },  
 70521: () => { Module.exitFullscreen(false, true); },  
 70557: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
