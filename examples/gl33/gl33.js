...
var ASM_CONSTS = {
 ...
 69976: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70047: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70104: () => { return window.mouseX || 0; },  
 70135: () => { return window.mouseY || 0; },  
 70166: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70313: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70366: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70646: () => { return window.innerWidth; },  
 70676: () => { return window.innerHeight; },  
 70707: () => { Module.requestFullscreen(false, true); },  
 70746: () => { Module.exitFullscreen(false, true); },  
 70782: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
