...
var ASM_CONSTS = {
 ...
 69789: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69860: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69917: () => { return window.mouseX || 0; },  
 69948: () => { return window.mouseY || 0; },  
 69979: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70126: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70179: () => { return window.innerWidth; },  
 70209: () => { return window.innerHeight; },  
 70240: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70520: () => { Module.requestFullscreen(false, true); },  
 70559: () => { Module.exitFullscreen(false, true); },  
 70595: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
