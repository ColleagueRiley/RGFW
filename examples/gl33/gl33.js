...
var ASM_CONSTS = {
 ...
 70568: () => { Module.requestFullscreen(false, true); },  
 70607: () => { Module.exitFullscreen(false, true); },  
 70643: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
