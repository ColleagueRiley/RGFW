...
var ASM_CONSTS = {
 ...
 69453: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69524: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69581: () => { return window.mouseX || 0; },  
 69612: () => { return window.mouseY || 0; },  
 69643: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69790: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69843: () => { return window.innerWidth; },  
 69873: () => { return window.innerHeight; },  
 69904: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70184: () => { Module.requestFullscreen(false, true); },  
 70223: () => { Module.exitFullscreen(false, true); },  
 70259: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
