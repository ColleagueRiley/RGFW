...
var ASM_CONSTS = {
 ...
 73055: () => { Module.requestFullscreen(false, true); },  
 73094: () => { Module.exitFullscreen(false, true); },  
 73130: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
