...
var ASM_CONSTS = {
 ...
 70677: () => { return window.innerWidth; },  
 70707: () => { return window.innerHeight; },  
 70738: () => { Module.requestFullscreen(false, true); },  
 70777: () => { Module.exitFullscreen(false, true); },  
 70813: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
