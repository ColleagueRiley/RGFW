...
var ASM_CONSTS = {
 ...
 69411: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69482: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69539: () => { return window.mouseX || 0; },  
 69570: () => { return window.mouseY || 0; },  
 69601: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69748: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69801: () => { return window.innerWidth; },  
 69831: () => { return window.innerHeight; },  
 69862: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70142: () => { Module.requestFullscreen(false, true); },  
 70181: () => { Module.exitFullscreen(false, true); },  
 70217: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
