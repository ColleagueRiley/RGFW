...
var ASM_CONSTS = {
 ...
 70679: () => { return 'Asyncify' in Module; },  
 70712: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70783: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70840: () => { return window.mouseX || 0; },  
 70871: () => { return window.mouseY || 0; },  
 70902: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71049: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71102: () => { Module.useWebGL = true; GLImmediate.init(); },  
 71148: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 71428: () => { return window.innerWidth; },  
 71458: () => { return window.innerHeight; },  
 71489: () => { Module.requestFullscreen(false, true); },  
 71528: () => { Module.exitFullscreen(false, true); },  
 71564: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
