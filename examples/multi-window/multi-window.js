...
var ASM_CONSTS = {
 ...
 69977: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70048: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70105: () => { return window.mouseX || 0; },  
 70136: () => { return window.mouseY || 0; },  
 70167: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70314: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70367: () => { Module.useWebGL = true; GLImmediate.init(); },  
 70413: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70693: () => { return window.innerWidth; },  
 70723: () => { return window.innerHeight; },  
 70754: () => { Module.requestFullscreen(false, true); },  
 70793: () => { Module.exitFullscreen(false, true); },  
 70829: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
