...
var ASM_CONSTS = {
 ...
 70504: () => { return window.innerWidth; },  
 70534: () => { return window.innerHeight; },  
 70565: () => { Module.requestFullscreen(false, true); },  
 70604: () => { Module.exitFullscreen(false, true); },  
 70640: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
