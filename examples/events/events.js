...
var ASM_CONSTS = {
 ...
 69739: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69810: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69867: () => { return window.mouseX || 0; },  
 69898: () => { return window.mouseY || 0; },  
 69929: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70076: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70129: () => { return window.innerWidth; },  
 70159: () => { return window.innerHeight; },  
 ...
 70470: () => { Module.requestFullscreen(false, true); },  
 70509: () => { Module.exitFullscreen(false, true); },  
 70545: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
