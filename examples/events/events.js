...
var ASM_CONSTS = {
 ...
 67356: () => { window.addEventListener("keydown", (event) => { Module._RGFW_handleKeyMods(event.getModifierState("CapsLock"), event.getModifierState("NumLock"), event.getModifierState("Control"), event.getModifierState("Alt"), event.getModifierState("Shift"), event.getModifierState("Meta")); Module._RGFW_handleKeyEvent(stringToNewUTF8(event.key), stringToNewUTF8(event.code), 1); }, true); },  
 ...
 68756: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 68827: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 68884: () => { return window.mouseX || 0; },  
 68915: () => { return window.mouseY || 0; },  
 68946: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69093: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69146: () => { return window.innerWidth; },  
 69176: () => { return window.innerHeight; }
};
