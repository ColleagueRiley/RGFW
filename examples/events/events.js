...
var ASM_CONSTS = {
 ...
 73359: () => { Module.requestFullscreen(false, true); },  
 73398: () => { Module.exitFullscreen(false, true); },  
 73434: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
