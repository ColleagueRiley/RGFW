...
var ASM_CONSTS = {
 ...
 71556: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71627: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71684: () => { return window.mouseX || 0; },  
 71715: () => { return window.mouseY || 0; },  
 71746: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71893: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71946: () => { return window.innerWidth; },  
 71976: () => { return window.innerHeight; },  
 72007: () => { Module.requestFullscreen(false, true); },  
 72046: () => { Module.exitFullscreen(false, true); },  
 72082: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
