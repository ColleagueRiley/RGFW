...
var ASM_CONSTS = {
 ...
 72908: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 72979: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 73036: () => { return window.mouseX || 0; },  
 73067: () => { return window.mouseY || 0; },  
 73098: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 73245: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73298: () => { return window.innerWidth; },  
 73328: () => { return window.innerHeight; },  
 73359: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 73639: () => { Module.requestFullscreen(false, true); },  
 73678: () => { Module.exitFullscreen(false, true); },  
 73714: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
