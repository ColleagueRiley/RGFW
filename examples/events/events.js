...
var ASM_CONSTS = {
 ...
 70315: () => { return window.innerWidth; },  
 70345: () => { return window.innerHeight; },  
 70376: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70433: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
