...
var ASM_CONSTS = {
 ...
 70518: () => { Module.requestFullscreen(false, true); },  
 70557: () => { Module.exitFullscreen(false, true); },  
 70593: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
