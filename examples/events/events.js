...
var ASM_CONSTS = {
 ...
 69827: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69898: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69955: () => { return window.mouseX || 0; },  
 69986: () => { return window.mouseY || 0; },  
 70017: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70164: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70217: () => { return window.innerWidth; },  
 70247: () => { return window.innerHeight; },  
 70278: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70558: () => { Module.requestFullscreen(false, true); },  
 70597: () => { Module.exitFullscreen(false, true); },  
 70633: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
