...
var ASM_CONSTS = {
 ...
 67841: () => { Module.useWebGL = true; GLImmediate.init(); },  
 ...
 69859: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69930: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69987: () => { return window.mouseX || 0; },  
 70018: () => { return window.mouseY || 0; },  
 70049: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70196: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70249: () => { return window.innerWidth; },  
 70279: () => { return window.innerHeight; },  
 70310: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70590: () => { Module.requestFullscreen(false, true); },  
 70629: () => { Module.exitFullscreen(false, true); },  
 70665: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
