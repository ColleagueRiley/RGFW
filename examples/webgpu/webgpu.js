...
var ASM_CONSTS = {
 ...
 70012: () => { Module.requestFullscreen(false, true); },  
 70051: () => { Module.exitFullscreen(false, true); },  
 70087: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
