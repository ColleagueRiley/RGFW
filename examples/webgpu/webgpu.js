...
var ASM_CONSTS = {
 ...
 69377: () => { Module.requestFullscreen(false, true); },  
 69416: () => { Module.exitFullscreen(false, true); },  
 69452: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
