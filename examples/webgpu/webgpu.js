...
var ASM_CONSTS = {
 ...
 72737: () => { Module.requestFullscreen(false, true); },  
 72776: () => { Module.exitFullscreen(false, true); },  
 72812: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
