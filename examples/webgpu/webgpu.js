...
var ASM_CONSTS = {
 ...
 68618: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 68689: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 68746: () => { return window.mouseX || 0; },  
 68777: () => { return window.mouseY || 0; },  
 68808: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 68955: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69008: () => { return window.innerWidth; },  
 69038: () => { return window.innerHeight; }
};
