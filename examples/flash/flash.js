...
var ASM_CONSTS = {
 ...
 67443: () => { return window.innerWidth || 0; },  
 67476: () => { return window.innerHeight || 0; },  
 ...
 69942: () => { Module.requestFullscreen(false, true); },  
 69981: () => { Module.exitFullscreen(false, true); },  
 70017: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
