...
var ASM_CONSTS = {
 ...
 69903: () => { return 'Asyncify' in Module; },  
 69936: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70007: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70064: () => { return window.mouseX || 0; },  
 70095: () => { return window.mouseY || 0; },  
 70126: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70273: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70326: () => { return window.innerWidth; },  
 70356: () => { return window.innerHeight; },  
 70387: () => { Module.requestFullscreen(false, true); },  
 70426: () => { Module.exitFullscreen(false, true); },  
 70462: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
