...
var ASM_CONSTS = {
 ...
 69846: () => { return window.innerWidth; },  
 69876: () => { return window.innerHeight; },  
 69907: () => { Module.requestFullscreen(false, true); },  
 69946: () => { Module.exitFullscreen(false, true); },  
 69982: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
