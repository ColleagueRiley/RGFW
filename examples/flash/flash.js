...
var ASM_CONSTS = {
 ...
 69919: () => { return 'Asyncify' in Module; },  
 69952: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70023: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70080: () => { return window.mouseX || 0; },  
 70111: () => { return window.mouseY || 0; },  
 70142: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70289: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70342: () => { return window.innerWidth; },  
 70372: () => { return window.innerHeight; },  
 70403: () => { Module.requestFullscreen(false, true); },  
 70442: () => { Module.exitFullscreen(false, true); },  
 70478: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
