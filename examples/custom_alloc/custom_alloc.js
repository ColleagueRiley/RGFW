...
var ASM_CONSTS = {
 ...
 69823: () => { return window.innerWidth; },  
 69853: () => { return window.innerHeight; },  
 69884: () => { Module.requestFullscreen(false, true); },  
 69923: () => { Module.exitFullscreen(false, true); },  
 69959: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
