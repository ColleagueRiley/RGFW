...
var ASM_CONSTS = {
 ...
 69225: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69296: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69353: () => { return window.mouseX || 0; },  
 69384: () => { return window.mouseY || 0; },  
 69415: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69615: () => { return window.innerWidth; },  
 69645: () => { return window.innerHeight; },  
 69676: () => { Module.requestFullscreen(false, true); },  
 69715: () => { Module.exitFullscreen(false, true); },  
 69751: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
