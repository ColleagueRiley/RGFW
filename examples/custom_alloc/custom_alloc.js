...
var ASM_CONSTS = {
 ...
 69567: () => { return 'Asyncify' in Module; },  
 ...
 69990: () => { return window.innerWidth; },  
 70020: () => { return window.innerHeight; },  
 70051: () => { Module.requestFullscreen(false, true); },  
 70090: () => { Module.exitFullscreen(false, true); },  
 70126: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
