...
var ASM_CONSTS = {
 ...
 69862: () => { return window.innerWidth; },  
 69892: () => { return window.innerHeight; },  
 69923: () => { Module.requestFullscreen(false, true); },  
 69962: () => { Module.exitFullscreen(false, true); },  
 69998: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
