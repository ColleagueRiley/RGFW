...
var ASM_CONSTS = {
 ...
 69839: () => { return window.innerWidth; },  
 69869: () => { return window.innerHeight; },  
 69900: () => { Module.requestFullscreen(false, true); },  
 69939: () => { Module.exitFullscreen(false, true); },  
 69975: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
