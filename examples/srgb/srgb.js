...
var ASM_CONSTS = {
 ...
 70358: () => { Module.useWebGL = true; GLImmediate.init(); },  
 70404: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70684: () => { return window.innerWidth; },  
 70714: () => { return window.innerHeight; },  
 70745: () => { Module.requestFullscreen(false, true); },  
 70784: () => { Module.exitFullscreen(false, true); },  
 70820: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
