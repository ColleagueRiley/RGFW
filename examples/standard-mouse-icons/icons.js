...
var ASM_CONSTS = {
 ...
 69596: () => { Module.requestFullscreen(false, true); },  
 69635: () => { Module.exitFullscreen(false, true); },  
 69671: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
