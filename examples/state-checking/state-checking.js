...
var ASM_CONSTS = {
 ...
 70150: () => { return window.innerWidth; },  
 70180: () => { return window.innerHeight; },  
 70211: () => { Module.requestFullscreen(false, true); },  
 70250: () => { Module.exitFullscreen(false, true); },  
 70286: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
