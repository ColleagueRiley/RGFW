...
var ASM_CONSTS = {
 ...
 70367: () => { return window.innerWidth; },  
 70397: () => { return window.innerHeight; },  
 70428: () => { Module.requestFullscreen(false, true); },  
 70467: () => { Module.exitFullscreen(false, true); },  
 70503: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
