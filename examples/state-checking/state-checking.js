...
var ASM_CONSTS = {
 ...
 70870: () => { return window.innerWidth; },  
 70900: () => { return window.innerHeight; },  
 70931: () => { Module.requestFullscreen(false, true); },  
 70970: () => { Module.exitFullscreen(false, true); },  
 71006: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
