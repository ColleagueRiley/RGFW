...
var ASM_CONSTS = {
 ...
 69797: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69868: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69925: () => { return window.mouseX || 0; },  
 69956: () => { return window.mouseY || 0; },  
 69987: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70187: () => { return window.innerWidth; },  
 70217: () => { return window.innerHeight; },  
 70248: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70528: () => { Module.requestFullscreen(false, true); },  
 70567: () => { Module.exitFullscreen(false, true); },  
 70603: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
