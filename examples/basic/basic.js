...
var ASM_CONSTS = {
 ...
 69931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70059: () => { return window.mouseX || 0; },  
 70090: () => { return window.mouseY || 0; },  
 70121: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70268: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70321: () => { return window.innerWidth; },  
 70351: () => { return window.innerHeight; },  
 70382: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
