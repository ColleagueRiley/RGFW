...
var ASM_CONSTS = {
 ...
 69060: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69131: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69188: () => { return window.mouseX || 0; },  
 69219: () => { return window.mouseY || 0; },  
 69250: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69397: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69450: () => { return window.innerWidth; },  
 69480: () => { return window.innerHeight; },  
 69511: () => { Module.requestFullscreen(false, true); },  
 69550: () => { Module.exitFullscreen(false, true); },  
 69586: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
