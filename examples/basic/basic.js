...
var ASM_CONSTS = {
 ...
 68829: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 68900: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 68957: () => { return window.mouseX || 0; },  
 68988: () => { return window.mouseY || 0; },  
 69019: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69166: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69219: () => { return window.innerWidth; },  
 69249: () => { return window.innerHeight; }
};
