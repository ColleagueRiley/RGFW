...
var ASM_CONSTS = {
  69088: () => { Module.useWebGL = true; GLImmediate.init(); },  
 69134: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69205: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69262: () => { return window.mouseX || 0; },  
 69293: () => { return window.mouseY || 0; },  
 69324: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69471: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69524: () => { return window.innerWidth; },  
 69554: () => { return window.innerHeight; }
};
