...
var ASM_CONSTS = {
 ...
 69188: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69259: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69316: () => { return window.mouseX || 0; },  
 69347: () => { return window.mouseY || 0; },  
 69378: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 69525: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 69578: () => { return window.innerWidth; },  
 69608: () => { return window.innerHeight; },  
 69639: () => { Module.requestFullscreen(false, true); }
};
