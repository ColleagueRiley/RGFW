...
var ASM_CONSTS = {
 ...
 68187: () => { return window.innerWidth; },  
 68217: () => { return window.innerHeight; },  
 68248: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 68305: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
