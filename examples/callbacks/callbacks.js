...
var ASM_CONSTS = {
 ...
 69677: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69748: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69805: () => { return window.mouseX || 0; },  
 69836: () => { return window.mouseY || 0; },  
 69867: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70014: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70067: () => { return window.innerWidth; },  
 70097: () => { return window.innerHeight; },  
 70128: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70408: () => { Module.requestFullscreen(false, true); },  
 70447: () => { Module.exitFullscreen(false, true); },  
 70483: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
