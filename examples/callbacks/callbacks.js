...
var ASM_CONSTS = {
 ...
 70415: () => { return window.innerWidth; },  
 70445: () => { return window.innerHeight; },  
 70476: () => { Module.requestFullscreen(false, true); },  
 70515: () => { Module.exitFullscreen(false, true); },  
 70551: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
