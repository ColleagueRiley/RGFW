...
var ASM_CONSTS = {
 ...
 70079: () => { return 'Asyncify' in Module; },  
 70112: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70183: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70240: () => { return window.mouseX || 0; },  
 70271: () => { return window.mouseY || 0; },  
 70302: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70449: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70502: () => { return window.innerWidth; },  
 70532: () => { return window.innerHeight; },  
 70563: () => { Module.requestFullscreen(false, true); },  
 70602: () => { Module.exitFullscreen(false, true); },  
 70638: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
