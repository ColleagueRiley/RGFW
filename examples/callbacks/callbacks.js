...
var ASM_CONSTS = {
 ...
 70079: () => { return window.innerWidth; },  
 70109: () => { return window.innerHeight; },  
 70140: () => { Module.requestFullscreen(false, true); },  
 70179: () => { Module.exitFullscreen(false, true); },  
 70215: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
