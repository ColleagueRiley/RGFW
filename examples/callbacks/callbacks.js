...
var ASM_CONSTS = {
 ...
 70491: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70562: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70619: () => { return window.mouseX || 0; },  
 70650: () => { return window.mouseY || 0; },  
 70681: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70828: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70881: () => { return window.innerWidth; },  
 70911: () => { return window.innerHeight; }
};
