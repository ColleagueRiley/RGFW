...
var ASM_CONSTS = {
 ...
 70427: () => { return window.innerWidth; },  
 70457: () => { return window.innerHeight; },  
 70488: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70545: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
