...
var ASM_CONSTS = {
 ...
 71015: () => { return 'Asyncify' in Module; },  
 71048: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 71119: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 71176: () => { return window.mouseX || 0; },  
 71207: () => { return window.mouseY || 0; },  
 71238: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71385: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71438: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 71718: () => { return window.innerWidth; },  
 71748: () => { return window.innerHeight; },  
 71779: () => { Module.requestFullscreen(false, true); },  
 71818: () => { Module.exitFullscreen(false, true); },  
 71854: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
