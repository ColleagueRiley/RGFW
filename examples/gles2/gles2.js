...
var ASM_CONSTS = {
 ...
 70438: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70718: () => { return window.innerWidth; },  
 70748: () => { return window.innerHeight; },  
 70779: () => { Module.requestFullscreen(false, true); },  
 70818: () => { Module.exitFullscreen(false, true); },  
 70854: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
