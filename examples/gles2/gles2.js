...
var ASM_CONSTS = {
 ...
 70624: () => { Module.requestFullscreen(false, true); },  
 70663: () => { Module.exitFullscreen(false, true); },  
 70699: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
