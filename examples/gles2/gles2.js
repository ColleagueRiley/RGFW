...
var ASM_CONSTS = {
 ...
 71070: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 71350: () => { return window.innerWidth; },  
 71380: () => { return window.innerHeight; },  
 71411: () => { Module.requestFullscreen(false, true); },  
 71450: () => { Module.exitFullscreen(false, true); },  
 71486: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
