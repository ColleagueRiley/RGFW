...
var ASM_CONSTS = {
 ...
 70770: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70841: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70898: () => { return window.mouseX || 0; },  
 70929: () => { return window.mouseY || 0; },  
 70960: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 71107: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 71160: () => { return window.innerWidth; },  
 71190: () => { return window.innerHeight; },  
 71221: () => { Module.requestFullscreen(false, true); },  
 71260: () => { Module.exitFullscreen(false, true); },  
 71296: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
