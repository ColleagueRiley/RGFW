...
var ASM_CONSTS = {
 ...
 70111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 70182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70239: () => { return window.mouseX || 0; },  
 70270: () => { return window.mouseY || 0; },  
 70301: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70448: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70501: () => { return window.innerWidth; },  
 70531: () => { return window.innerHeight; }
};
