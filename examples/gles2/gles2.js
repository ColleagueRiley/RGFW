...
var ASM_CONSTS = {
 ...
 69807: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69878: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69935: () => { return window.mouseX || 0; },  
 69966: () => { return window.mouseY || 0; },  
 69997: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70144: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70197: () => { return window.innerWidth; },  
 70227: () => { return window.innerHeight; },  
 70258: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70538: () => { Module.requestFullscreen(false, true); },  
 70577: () => { Module.exitFullscreen(false, true); },  
 70613: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
