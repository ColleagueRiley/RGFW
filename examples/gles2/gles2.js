...
var ASM_CONSTS = {
 ...
 70496: () => { Module.requestFullscreen(false, true); },  
 70535: () => { Module.exitFullscreen(false, true); },  
 70571: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
