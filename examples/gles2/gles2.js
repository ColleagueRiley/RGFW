...
var ASM_CONSTS = {
 ...
 69869: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69940: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69997: () => { return window.mouseX || 0; },  
 70028: () => { return window.mouseY || 0; },  
 70059: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70259: () => { return window.innerWidth; },  
 70289: () => { return window.innerHeight; },  
 70320: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70600: () => { Module.requestFullscreen(false, true); },  
 70639: () => { Module.exitFullscreen(false, true); },  
 70675: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
