...
var ASM_CONSTS = {
 ...
 90776: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 90847: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 90904: () => { return window.mouseX || 0; },  
 90935: () => { return window.mouseY || 0; },  
 90966: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 91113: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91166: () => { Module.useWebGL = true; GLImmediate.init(); },  
 91212: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 91492: () => { return window.innerWidth; },  
 91522: () => { return window.innerHeight; },  
 91553: () => { Module.requestFullscreen(false, true); },  
 91592: () => { Module.exitFullscreen(false, true); },  
 91628: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
