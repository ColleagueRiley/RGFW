...
var ASM_CONSTS = {
 ...
 90785: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 90856: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 90913: () => { return window.mouseX || 0; },  
 90944: () => { return window.mouseY || 0; },  
 90975: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 91122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91175: () => { Module.useWebGL = true; GLImmediate.init(); },  
 91221: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 91501: () => { return window.innerWidth; },  
 91531: () => { return window.innerHeight; },  
 91562: () => { Module.requestFullscreen(false, true); },  
 91601: () => { Module.exitFullscreen(false, true); },  
 91637: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
