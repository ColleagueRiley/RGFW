...
var ASM_CONSTS = {
 ...
 94031: () => { Module.requestFullscreen(false, true); },  
 94070: () => { Module.exitFullscreen(false, true); },  
 94106: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
