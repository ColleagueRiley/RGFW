...
var ASM_CONSTS = {
 ...
 72107: () => { Module.requestFullscreen(false, true); },  
 72146: () => { Module.exitFullscreen(false, true); },  
 72182: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
