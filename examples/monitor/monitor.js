...
var ASM_CONSTS = {
 ...
 68521: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 68592: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 68649: () => { return window.mouseX || 0; },  
 68680: () => { return window.mouseY || 0; },  
 68711: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 68858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 68911: () => { return window.innerWidth; },  
 68941: () => { return window.innerHeight; },  
 68972: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 69252: () => { Module.requestFullscreen(false, true); },  
 69291: () => { Module.exitFullscreen(false, true); },  
 69327: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
