...
var ASM_CONSTS = {
 ...
 69817: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69888: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 69945: () => { return window.mouseX || 0; },  
 69976: () => { return window.mouseY || 0; },  
 70007: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70154: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70207: () => { Module.useWebGL = true; GLImmediate.init(); },  
 70253: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 70533: () => { return window.innerWidth; },  
 70563: () => { return window.innerHeight; },  
 70594: () => { Module.requestFullscreen(false, true); },  
 70633: () => { Module.exitFullscreen(false, true); },  
 70669: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
