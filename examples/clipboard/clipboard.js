...
var ASM_CONSTS = {
 ...
 69871: () => { return 'Asyncify' in Module; },  
 69904: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 69975: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 70032: () => { return window.mouseX || 0; },  
 70063: () => { return window.mouseY || 0; },  
 70094: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 70241: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70294: () => { return window.innerWidth; },  
 70324: () => { return window.innerHeight; },  
 70355: () => { Module.requestFullscreen(false, true); },  
 70394: () => { Module.exitFullscreen(false, true); },  
 70430: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
