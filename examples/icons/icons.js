...
var ASM_CONSTS = {
 ...
 78600: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 78671: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 78728: () => { return window.mouseX || 0; },  
 78759: () => { return window.mouseY || 0; },  
 78790: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 78937: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 78990: () => { return window.innerWidth; },  
 79020: () => { return window.innerHeight; },  
 79051: () => { Module.requestFullscreen(false, true); }
};
