...
var ASM_CONSTS = {
 ...
 79349: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79420: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79477: () => { return window.mouseX || 0; },  
 79508: () => { return window.mouseY || 0; },  
 79539: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 79686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79739: () => { return window.innerWidth; },  
 79769: () => { return window.innerHeight; },  
 79800: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 80080: () => { Module.requestFullscreen(false, true); },  
 80119: () => { Module.exitFullscreen(false, true); },  
 80155: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
