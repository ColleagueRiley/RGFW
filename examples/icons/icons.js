...
var ASM_CONSTS = {
 ...
 82935: () => { Module.requestFullscreen(false, true); },  
 82974: () => { Module.exitFullscreen(false, true); },  
 83010: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
