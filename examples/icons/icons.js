...
var ASM_CONSTS = {
 ...
 79291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79419: () => { return window.mouseX || 0; },  
 79450: () => { return window.mouseY || 0; },  
 79481: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 79628: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79681: () => { return window.innerWidth; },  
 79711: () => { return window.innerHeight; },  
 79742: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 80022: () => { Module.requestFullscreen(false, true); },  
 80061: () => { Module.exitFullscreen(false, true); },  
 80097: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
